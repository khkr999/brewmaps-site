...
<div class="abs kick" style="left:{M}px;top:210px;font-size:27px;color:var(--mint);">And you earned</div>
<div class="abs num" style="left:0;top:308px;width:1080px;text-align:center;font-size:616px;">{POINTS_PLACEHOLDER}</div>
<h1 class="h abs" style="left:{M-5}px;top:872px;font-size:104px;">BrewPoints<span style="color:var(--mint)">.</span></h1>
<div class="abs" style="left:{M}px;top:1042px;font-size:29px;font-weight:500;color:rgba(244,239,230,.62);">Earned through your BrewMaps check-ins.</div>'''

# ── 3  DATA AS DESIGN — cream, asymmetric, check-in photos bled to the edges
S3=f'''{H}<style>body{{background:var(--sand);color:var(--green);}}</style>
...
# ── 4  SHARE — headline, CTA and calendar as one block
TILE=136
