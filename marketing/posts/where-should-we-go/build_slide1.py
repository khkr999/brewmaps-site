...
{phone(B,Bs+150,icon='../../assets/logos/mark-cream.png')}
...
<img class="abs" src="../../assets/logos/logo-green.png" style="right:70px;bottom:60px;width:70px;opacity:.9;">'''
open('slide-1.html','w').write(html)
