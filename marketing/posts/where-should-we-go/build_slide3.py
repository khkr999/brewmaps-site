...
html=f'''<link rel="stylesheet" href="../../assets/base.css">
...
<div class="screen"><img src="../../assets/screenshots/browse-dubai.png"></div>
<img class="abs" src="../../assets/logos/logo-green.png" style="right:70px;top:150px;width:70px;opacity:.9;">'''
open('slide-3.html','w').write(html)
