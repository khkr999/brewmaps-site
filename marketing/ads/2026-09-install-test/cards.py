...
cards = [
 ...
 ('c7', page('<img src="src/logo-cream.png" style="width:150px"><div class="line" style="font-size:62px;margin-top:34px;">@brewmaps</div><div class="sub">413 cafés. 29 areas.</div>')),
]
